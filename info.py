...
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://AutoFilter:<db_password>@heartfilter.rrt16.mongodb.net/?retryWrites=true&w=majority&appName=HeartFilter")
